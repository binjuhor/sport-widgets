...
import GolfTournament from '@/components/GolfTournament.vue'

const GolfTournamentWithStyles = {
  ...GolfTournament,
  styles: [
    ...
    .dsgw-golf-tournaments-widget.dsgw-mb .dsgw-player-group {
        justify-content: start;
    }`
  ],
};

const golfTournament = defineCustomElement(GolfTournamentWithStyles);
window.customElements.define('golf-tournament', golfTournament);